-- $Id: Atlas_Transportation.lua 2274 2015-03-01 07:44:40Z arithmandar $
--[[
...
local myData = {
	TransAllianceDraenor = {
		...
		{ WHIT.." 1) "..BZ["Lunarfall"] };
		{ WHIT.." 2) "..BZ["Exile's Rise"] };
		{ WHIT.." 3) "..BZ["Embaari Village"] };
		{ WHIT.." 4) "..BZ["Path of Light"] };
		{ WHIT.." 5) "..BZ["Elodor"] };
		{ WHIT.." 6) "..BZ["Tranquil Court"] };
		{ WHIT.." 7) "..BZ["The Draakorium"] };
		{ WHIT.." 8) "..BZ["Twilight Glade"] };
		{ WHIT.." 9) "..BZ["Socrethar's Rise"] };
		{ WHIT.."10) "..BZ["Darktide Roost"] };
		{ "" };
		{ BLUE..BZ["Talador"] };
		{ WHIT.."11) "..BZ["Anchorite's Sojourn"] };
		{ WHIT.."12) "..BZ["Terokkar Refuge"] };
		{ WHIT.."13) "..BZ["Exarch's Refuge"] };
		{ WHIT.."14) "..BZ["Retribution Point"] };
		{ WHIT.."15) "..BZ["Shattrath City"] };
		{ WHIT.."16) "..BZ["Redemption Rise"] };
		{ WHIT.."17) "..BZ["Fort Wrynn"] };
		{ WHIT.."18) "..BZ["Zangarra"] };
		{ "" };
		{ BLUE..BZ["Gorgrond"] };
		{ WHIT.."19) "..BZ["Bastion Rise"] };
		{ WHIT.."20) "..BZ["Deeproot"] };
		{ WHIT.."21) "..BZ["Highpass"] };
		{ WHIT.."22) "..BZ["Wildwood Wash"] };
		{ WHIT.."23) "..BZ["Everbloom Wilds"] };
		{ WHIT.."24) "..BZ["Everbloom Overlook"] };
		{ WHIT.."25) "..BZ["Breaker's Crown"] };
		{ WHIT.."26) "..BZ["Skysea Point"] };
		{ WHIT.."27) "..BZ["Iron Docks"] };
		{ "" };
		{ BLUE..BZ["Spires of Arak"] };
		{ WHIT.."28) "..BZ["Apexis Excavation"] };
		{ WHIT.."29) "..BZ["Southport"] };
		{ WHIT.."28) "..BZ["Axefall"] };
		{ WHIT.."30) "..BZ["Veil Terokk"] };
		{ WHIT.."31) "..BZ["Crow's Crook"] };
		{ WHIT.."32) "..BZ["Talon Watch"] };
		{ WHIT.."33) "..BZ["Pinchwhistle Gearworks"] };
		{ WHIT.."34) "..BZ["Akeeta's Hovel"] };
		{ "" };
		{ BLUE..BZ["Nagrand"] };
		{ WHIT.."35) "..BZ["The Ring of Trials"] };
		{ WHIT.."36) "..BZ["Telaari Station"] };
		{ WHIT.."37) "..BZ["Nivek's Overlook"] };
		{ WHIT.."38) "..BZ["Yrel's Watch"] };
		{ WHIT.."39) "..BZ["Rilzit's Holdfast"] };
		{ WHIT.."40) "..BZ["Joz's Rylaks"] };
		{ WHIT.."41) "..BZ["Throne of the Elements"] };
		{ "" };
		{ BLUE..BZ["Frostfire Ridge"] };
		{ WHIT.."42) "..BZ["Iron Siegeworks"] };
	...
	TransHordeDraenor = {
		...
		{ PURP.." C') "..BZ["Undercity"]..", "..BZ["Tirisfal Glades"]..", "..BZ["Eastern Kingdoms"] };
		{ WHIT.."18) "..BZ["Zangarra"]..", "..BZ["Talador"] };
		{ "" };
		{ _RED..AL["Taxi Nodes"] };
		{ BLUE..BZ["Frostfire Ridge"] };
		...
		{ "" };
		{ BLUE..BZ["Gorgrond"] };
		{ WHIT.."10) "..BZ["Evermorn Springs"] };
		{ WHIT.."11) "..BZ["Bastion Rise"] };
		{ WHIT.."12) "..BZ["Beastwatch"] };
		{ WHIT.."13) "..BZ["Breaker's Crown"] };
		{ WHIT.."14) "..BZ["Skysea Point"] };
		{ WHIT.."15) "..BZ["Iron Docks"] };
		{ WHIT.."16) "..BZ["Everbloom Wilds"] };
		{ WHIT.."17) "..BZ["Everbloom Overlook"] };
		{ "" };
		{ BLUE..BZ["Talador"] };
		{ WHIT.."18) "..BZ["Zangarra"] };
		{ WHIT.."19) "..BZ["Vol'jin's Pride"] };
		{ WHIT.."20) "..BZ["Frostwolf Overlook"] };
		{ WHIT.."21) "..BZ["Durotan's Grasp"] };
		{ WHIT.."22) "..BZ["Shattrath City"] };
		{ WHIT.."23) "..BZ["Terokkar Refuge"] };
		{ WHIT.."24) "..BZ["Exarch's Refuge"] };
		{ WHIT.."25) "..BZ["Retribution Point"] };
		{ "" };
		{ BLUE..BZ["Spires of Arak"] };
		{ WHIT.."26) "..BZ["Apexis Excavation"] };
		{ WHIT.."27) "..BZ["Crow's Crook"] };
		{ WHIT.."28) "..BZ["Axefall"] };
		{ WHIT.."29) "..BZ["Veil Terokk"] };
		{ WHIT.."30) "..BZ["Talon Watch"] };
		{ WHIT.."31) "..BZ["Pinchwhistle Gearworks"] };
		{ WHIT.."32) "..BZ["Akeeta's Hovel"] };
		{ "" };
		{ BLUE..BZ["Nagrand"] };
		{ WHIT.."33) "..BZ["Wor'var"] };
		{ WHIT.."34) "..BZ["The Ring of Trials"] };
		{ WHIT.."35) "..BZ["Throne of the Elements"] };
		{ WHIT.."36) "..BZ["Joz's Rylaks"] };
		{ WHIT.."37) "..BZ["Rilzit's Holdfast"] };
		{ WHIT.."38) "..BZ["Riverside Post"] };
		{ WHIT.."39) "..BZ["Nivek's Overlook"] };
		{ "" };
		{ BLUE..BZ["Shadowmoon Valley"] };
		{ WHIT.."40) "..BZ["Exile's Rise"] };
		{ WHIT.."41) "..BZ["Socrethar's Rise"] };
		{ WHIT.."42) "..BZ["Darktide Roost"] };
		{ "" };
		{ BLUE..BZ["Ashran"] };
		{ WHIT.."43) "..BZ["Warspear"] };
	};
