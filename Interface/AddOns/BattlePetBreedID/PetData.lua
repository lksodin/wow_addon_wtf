...
Last Update: Patch 6.0.2 Live; 2015-03-02T19:02:08Z
...
function BPBID_Arrays.InitializeArrays()
    ...
    BPBID_Arrays.BasePetStats[1604] = {10, 7.5, 6.5}
    ...
    BPBID_Arrays.BreedsPerSpecies[1480] = {8} -- TAMER: Quintessence of Light
    ...
    BPBID_Arrays.BreedsPerSpecies[1489] = {6} -- TAMER: Kromli
    BPBID_Arrays.BreedsPerSpecies[1490] = {6} -- TAMER: Gromli
    ...
    --BPBID_Arrays.BreedsPerSpecies[1641] = {???} -- TAMER: Dusty
