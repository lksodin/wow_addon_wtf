  ...
  cfg.colorswitcher = {
    ...
    classcolored        = false,  -- true   -> override the bright color with the unit specific color (class, faction, happiness, threat), if false uses the predefined color
  ...
  cfg.units = {
    ...
    player = {
      ...
      icons = {
        pvp = {
          show = true,
          pos = { a1 = "CENTER", a2 = "CENTER", x = 72, y = -40 }, --position in relation to self object
        },
        combat = {
          show = true,
      ...
      castbar = {
        ...
        scale = 0.8/1, --divide 1 by current unit scale if you want to prevent scaling of the castbar based on unit scale
        color = {
    ...
    target = {
      ...
      health = {
        texture = "Interface\\AddOns\\oUF_Diablo\\media\\statusbar256",
        tag = "[diablo:hpval]",
      },
      power = {
        texture = "Interface\\AddOns\\oUF_Diablo\\media\\statusbar",
      ...
      castbar = {
        show = true,
        texture = "Interface\\AddOns\\oUF_Diablo\\media\\statusbar256_2",
        scale = 0.9/1, --divide 1 by current unit scale if you want to prevent scaling of the castbar based on unit scale
        color = {
          bar = { r = 1, g = 0.7, b = 0, a = 1, },
          bg = { r = 0.1, g = 0.1, b = 0.1, a = 0.7, },
    ...
    targettarget = {
      ...
      health = {
        texture = "Interface\\AddOns\\oUF_Diablo\\media\\statusbar128",
        tag = "[diablo:misshp]",
      },
      power = {
        texture = "Interface\\AddOns\\oUF_Diablo\\media\\statusbar",
    ...
    focus = {
      ...
      castbar = {
        show = true,
        texture = "Interface\\AddOns\\oUF_Diablo\\media\\statusbar256_2",
        scale = 0.7/1, --divide 1 by current unit scale if you want to prevent scaling of the castbar based on unit scale
        color = {
          bar = { r = 1, g = 0.7, b = 0, a = 1, },
          bg = { r = 0.1, g = 0.1, b = 0.1, a = 0.7, },
        },
        pos = { a1 = "LEFT", a2 = "LEFT", af = "UIParent", x = 100, y = 420 },
      },
      healprediction = {
        show = false,
        texture = "Interface\\AddOns\\oUF_Diablo\\media\\statusbar",
