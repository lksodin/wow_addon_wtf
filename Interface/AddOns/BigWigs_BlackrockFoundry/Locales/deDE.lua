...
L["bombs_dropped_p2"] = "Ingenieur getötet, Bomben erschienen!" -- Needs review
...
L["custom_on_shieldsdown_marker"] = "Schilde unten markieren" -- Needs review
L["custom_on_shieldsdown_marker_desc"] = "Markiert eine verwundbare Urelementaristin mit {rt8}, benötigt Leiter oder Assistent." -- Needs review
L["engineer"] = "Schmelzofeningenieur spawnt" -- Needs review
L["engineer_desc"] = "Während Phase 1 spawnen wiederholt 2 Schmelzofeningenieure, einer auf jeder Seite des Raumes." -- Needs review
L["firecaller"] = "Feuerrufer spawnt" -- Needs review
L["firecaller_desc"] = "Während Phase 2 spawnen wiederholt 2 Feuerrufer, einer auf jeder Seite des Raumes." -- Needs review
L["guard"] = "Wachposten spawnt" -- Needs review
L["guard_desc"] = "Während Phase 1 spawnen wiederholt 2 Wachposten, einer auf jeder Seite des Raumes. Während Phase 2 spawnt wiederholt ein Wachposten am Eingang des Raumes." -- Needs review
L["heat_increased_message"] = "Hitze erhöht! Flammenzunge alle %s Sek."
L["operator"] = "Gebläsearbeiter spawnt" -- Needs review
L["operator_desc"] = "Während Phase 1 spawnen wiederholt 2 Gebläsearbeiter, einer auf jeder Seite des Raumes." -- Needs review
...
L["custom_off_firemender_marker"] = "Feuerheilerin der Grom'kar markieren" -- Needs review
L["custom_off_firemender_marker_desc"] = [=[Markiere Feuerheilerin der Grom'kar mit {rt1}{rt2}{rt3}{rt4}, benötigt Leiter oder Assistent.
|cFFFF0000Nur eine Person im Raid sollte diese Option aktiviert haben um Markierungskonflikte zu verhindern.|r
|cFFADFF2FTIPP: Wenn der Raid sich dafür entschieden hat, dass du diese Option aktivierst ist der schnellste Weg mit der Maus über die Mobs zu fahren um sie zu markieren.|r]=] -- Needs review
L["deforester"] = "Waldzerstörer spawnt" -- Needs review
L["lane"] = "Gleis %s: %s"
...
L["custom_off_markedfordeath_marker_desc"] = "Markiert die Ziele von Todesurteil mit {rt1}{rt2}{rt3}, benötigt Leiter oder Assistent." -- Needs review
L["custom_off_massivesmash_marker"] = "Massives vernichtendes Schmettern markieren" -- Needs review
L["custom_off_massivesmash_marker_desc"] = "Markiert den Tank, welcher von Massives vernichtendes Schmettern getroffen wird mit {rt6}, benötigt Leiter oder Assistent." -- Needs review
...
L["mistress"] = "Schmiedemeisterin Flammenhand" -- Needs review
