-- $Id: Atlas_Battlegrounds-zhCN.lua 2274 2015-03-01 07:44:40Z arithmandar $
--[[
...
if AL then
	...
	-- Silvershard Mines
	AL["Mine Cart Spawn Point"] = "矿车刷新点";
	AL["Mine Cart Depot"] = "矿车储藏点";

	-- Temple of Kotmogu
	AL["Orb of Power"] = "能量之球";
	AL["Center Point (Maximum Points)"] = "中间点（最大点）";
